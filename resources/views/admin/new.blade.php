...
<div id="page-wrapper">
    <div class="panel panel-primary top10">
        ...
        <div class="panel-body" >
            ...
            <form method="POST" action="{{ route('products.create') }}" class="form-horizontal" enctype="multipart/form-data" role="form">
                {!! csrf_field() !!}
                <fieldset>
                    <!-- Text input-->
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <textarea class="form-control" class="textarea" name="content"></textarea>
                        </div>
                    </div>
                    <div class="form-group">
