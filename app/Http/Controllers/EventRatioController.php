...
class EventRatioController extends Controller
{
    ...
    public function index()
    {
        ...
        $events = EventSport::with(['team', 'competitor', 'ratio', 'league'])->paginate(10);
        
        if (\Request::ajax()) {
            return \Response::json(view('ratio.list', compact('events'))->render());
        }
        return view('ratio.index', compact('events'));
    }
