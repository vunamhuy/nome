                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        @else
                            ...
                            <li class="divider"></li>
                            <li><a href="{{route('authenticated.logout')}}"><i class="fa fa-sign-out fa-fw"></i>  Logout </a></li>
                        @endif
                    </ul>
                    <!-- /.dropdown-user -->
                </li>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="{{route('user_account')}}"><i class="fa fa-dashboard fa-fw"></i>Manage page client</a>
                        </li>
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="{{route('products.home')}}">Lists</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="/ordered"><i class="glyphicon glyphicon-edit"></i> Clients orders</a>
                                </li>
                                <li>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="{{ route('user_account') }}"><i class="glyphicon glyphicon glyphicon-user"></i>Accounts</a>
                                </li>
                                <li>
