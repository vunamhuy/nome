...
Route::get('/', 'MainController@eventSports');
...
Route::group(['prefix' => 'livescores'], function()
{
    ...
    Route::get('/deposit', ['uses' =>'MainController@eventDeposit']);
});
...
Route::get('video/{filename}', [
	'as' => 'video', 'uses' => 'UserController@video']);
    ...
    Route::group(['prefix' => 'products'], function()
        {
            ...
            Route::group(['prefix' => 'import', 'as' => 'products.import'], function()
            {
                Route::get('/', 'ProductController@importProduct'); // from team
                Route::post('/', 'ProductController@importCsv');
            });
...
Route::group(['' => 'auth:all'], function()
{
	Route::group(['prefix' => 'user'], function()
	{
        ...
        {
            Route::get('/', ['uses' => 'UserController@account', 'as' => 'user_account']);
            Route::get('/charge', ['uses' => 'UserController@charge', 'as' => 'user_charge']);
            Route::post('/', ['uses' =>'UserController@updateAccount', 'as' => 'user_update_account']);
